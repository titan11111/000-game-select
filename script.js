...
// ゲームデータ（新しいゲームを追加）
const gameData = [
    { title: 'クエスト：冒険者の旅', category: 'adventure', keywords: 'クエスト 冒険 quest', url: 'https://titan11111.github.io/50-quest/', icon: '🗺️', isNew: true },
    ...
    { title: '格闘チャンピオン2：最強の挑戦者', category: 'action battle', keywords: '格闘 バトル 対戦', url: 'https://titan11111.github.io/43-kakuge2/', icon: '🥊', isNew: true },
    ...
    { title: '格闘チャンピオン', category: 'action battle', keywords: '格闘 バトル 対戦', url: 'https://titan11111.github.io/40-kakuge/', icon: '🥊', isNew: true },
    ...
    { title: 'サイバー英語：ネオンの学習', category: 'learning quiz', keywords: '英語 学習 サイバー 中学', url: 'https://titan11111.github.io/18-eigo2/', icon: '🌐' },
    ...
    { title: '歴史ストーリー：時空の旅', category: 'learning quiz', keywords: '歴史 勉強 ストーリー', url: 'https://titan11111.github.io/13-histry/', icon: '📚' },
    ...
    { title: '英語ゲーム：ワードクエスト', category: 'learning quiz', keywords: '英語 学習', url: 'https://titan11111.github.io/6-eigo-game/', icon: '📘' },
    ...
    { title: '化合物クイズ：サイエンスピース', category: 'learning quiz', keywords: '化合物 科学 理科 クイズ', url: 'https://titan11111.github.io/2-kagoubutu_game/', icon: '🧪' },
